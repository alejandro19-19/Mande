...
import "./ventanaRegistroInvalido.css";
import { Context } from "../../context/Context";
import ContratarServicio from "./../../assets/contratar_servicio.png";

function VentanaRegistroInvalido() {
  ...
  return (
    <div>
      <button onClick={abrirCerrarVentana} className="botonP_ResgistroInvalido">
...
export default VentanaRegistroInvalido;